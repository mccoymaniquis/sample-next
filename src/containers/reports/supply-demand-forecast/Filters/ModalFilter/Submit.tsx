...
function Submit() {
  ...
  useEffect(() => {
    ...
    const isRoleFamilyEmpty
      = !roleFamilyFilter || !roleFamilyFilter.id || roleFamilyFilter.id === "";
    const isCareerLevelEmpty
      = !careerLevelFilter || !careerLevelFilter.id || careerLevelFilter.id === "";
